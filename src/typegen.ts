...
export type ConfigNames = 'config/global-ignores' | 'config/gitignore' | 'config/js/recommended' | 'config/js' | 'config/comments/recommended' | 'config/comments' | 'config/imports' | 'config/unicorn/unopinionated' | 'config/unicorn' | 'config/node' | 'config/jsdoc' | 'config/regexp' | 'config/de-morgan' | 'config/typescript > typescript-eslint/base' | 'config/typescript > typescript-eslint/eslint-recommended' | 'config/typescript > typescript-eslint/recommended' | 'config/typescript' | 'config/typescript/dts-rules' | 'config/typescript/cjs-rules' | 'config/sort/imports' | 'config/markdown/recommended/plugin' | 'config/markdown/recommended/processor' | 'config/markdown/recommended/code-blocks' | 'config/markdown-rules' | 'config/yaml/setup' | 'config/yaml/rules' | 'config/json' | 'config/sort/package.json' | 'config/sort/tsconfig' | 'config/sort/pnpm-workspace' | 'config/vue/typescript > typescript-eslint/base' | 'config/vue/typescript > typescript-eslint/eslint-recommended' | 'config/vue/typescript > typescript-eslint/recommended' | 'config/vue/typescript' | 'config/vue' | 'config/vue/reactivity-transform' | 'config/unocss' | 'config/prettier' | 'config/command' | 'config/special/cli' | 'config/special/tests' | 'config/special/allow-default-export' | 'config/special/github' | 'config/special/components'
